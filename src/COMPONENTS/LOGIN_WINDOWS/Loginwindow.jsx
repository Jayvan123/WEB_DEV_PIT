  ...
  return (
    <div className='flex flex-row'> 
      <div className='flex-row ml-[100px] mt-[40px] h-[600px] w-[600px] bg-[#213A59] rounded-[10px]'>
        ...
        <input type="text" id="username" className='flex text text-white font-thin w-[350px] ml-[60px] mt-[5px] bg-[#072F5F] rounded-[3px] border-solid border-[1px] border-white'/>

        <label htmlFor="password" className='text-white flex text ml-[60px] mt-[15px] font-thin'>
          Password
        </label>
        <input type="password" id="password" className='flex text text-white font-thin w-[350px] ml-[60px] mt-[5px] bg-[#072F5F] rounded-[3px] border-solid border-[1px] border-white'/>
        ...
        <div>
          <NavLink to="/dashboard" className='block text-white text-[12px] font-sans w-[350px] h-[30px] ml-[60px] mt-[10px] bg-[#3784DC] rounded-[3px] border-solid border-[1px] border-white text-center leading-[30px]'>
            LOG IN
          </NavLink>
        </div>
